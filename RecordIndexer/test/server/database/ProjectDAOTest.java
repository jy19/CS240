...
public class ProjectDAOTest {
	...
	public void testGetAll() {
		ArrayList<Project> allProjects = ProjectTester.getAll();
		assertEquals(0, allProjects.size());
	}

	@Test
	public void testAdd() {
		Project p1 = new Project(1, "Project1!", 10, 100, 60);
		Project p2 = new Project(2, "Project 2", 5, 101, 62);
	...
	public void testUpdate() {
		Project project = new Project(-1, "project3", 11, 12, 13);
